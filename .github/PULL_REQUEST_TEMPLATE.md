...
- URL del repositorio
- URL del servicio/API/institución catalana a la que da soporte (p.ej. gencat.cat, aoc.cat, barcelona.cat)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución catalana |
|----------|-------------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de Catalunya, etc.)
Elimina esta sección si no aplica.
-->
